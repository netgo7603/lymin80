...
const ContactPage = () => {
  return (
    <>
      <Helmet>
        <title>문의하기 | Lymin80 Shop - 게임 포털</title>
        <meta name="description" content="Lymin80 Shop에 문의하세요. 서비스 이용, 버그 신고, 제안 사항 등 어떤 문의든 환영합니다." />
        <link rel="canonical" href={`${SITE_URL}/contact`} />
        <meta property="og:title" content="문의하기 | Lymin80 Shop" />
      ...
      <section className="py-16 min-h-screen">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <h1 className="text-4xl md:text-5xl font-black mb-6 font-display">문의<span className="text-blue-400">하기</span></h1>
