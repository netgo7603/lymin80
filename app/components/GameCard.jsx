...
export default function GameCard({ title, description, image, url, color }) {
  ...
  return (
    ...
    >
      ...
      <div className="p-6 relative z-10">
        ...
        <p className="text-gray-300 mb-6 font-light line-clamp-2">{description}</p>
      ...
      <ShareModal isOpen={isShareOpen} onClose={() => setIsShareOpen(false)} title={title} url={url} color={color} />
    </motion.div>
  );
}
